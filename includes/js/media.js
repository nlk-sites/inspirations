/**
 * Media handlers for Admin pages
 *
 */
( function( $ ) {
    // Image uploader
    $( function() {
        $.fn.mupload = function( options ) {
            ...
            $( options.button ).click( function() {
                ...
                tb_show( 'Upload image', 'media-upload.php?referer=problogger&type=image&TB_iframe=true&post_id=0', false );
        ...
        // Usage
        $( '.upload' ).mupload(); // Use as default option.
    } );
} ( jQuery ) );